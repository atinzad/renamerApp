...
def _init_state() -> None:
    ...
    st.session_state.setdefault("root_folder_id", "")
    st.session_state.setdefault("current_folder_id", "")
    st.session_state.setdefault("folder_nav_stack", [])
    st.session_state.setdefault("folder_nav_notice", "")
